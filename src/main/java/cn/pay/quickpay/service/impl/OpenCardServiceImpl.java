...
import cn.pay.quickpay.service.OpenCardService;
...
public class OpenCardServiceImpl implements OpenCardService {
    ...
    @Override
    public ResultVO openCard(HttpServletRequest request, HttpServletResponse response, MerchantBean mb, AgentXmlBean agentXmlBean, Properties agentProperties, Properties platformProperties) {

        String bizType=request.getParameter("bizType");
        String agentNo=request.getParameter("agentNo");

        //必填参数校验
        ResultVO openCardCodeParamVaildResult=QuickpayRequsetValid.openCardParamVaild(request);
        ...
        ResultVO openCardResult=channel.openCard(agentProperties,merchantCardBean, merchantChannelBean, mb, response);
