...
public class DateUtils {  
    ...
    /** yyyyMMddHHmm格式. */
    public static SimpleDateFormat dataTimeFormat3 = new SimpleDateFormat("yyyyMMddHHmm");
    
    /** yyyyMMddHHmmss格式. */
    public static SimpleDateFormat dataTimeFormat1 = new SimpleDateFormat("yyyyMMddHHmmss"); 
    
    /** yyyyMMddHHmm格式. */
    public static SimpleDateFormat dataTimeFormat2 = new SimpleDateFormat("yyyyMMdd HHmmss");
    
    /** yyyy-MM-dd HH:mm:ss. 数据库date类型默认使用该类型*/
...
//    }
    ...
    /**
     * 获取当前时间多少年之后的日期(如果想获取之前的日期  years可以传递为负数) 
     * @param sdf  格式化
     * @param years 年数
     * @return
     */
    public static String getAfterYears(SimpleDateFormat sdf,int years){ 
    Calendar now = Calendar.getInstance();
    ...
    /**
     * 获取当前时间多少月之后的日期(如果想获取之前的日期  months可以传递为负数) 
     * @param sdf  格式化
     * @param months 月数
     * @return
     */
    public static String getAfterMonths(SimpleDateFormat sdf,int months){ 
    Calendar now = Calendar.getInstance();
    ...
    /**
     * 获取当前时间多少天之后的日期(如果想获取之前的日期  days可以传递为负数) 
     * @param sdf  格式化
     * @param days 天数
     * @return
     */
    public static String getAfterDays(SimpleDateFormat sdf,int days){ 
    Calendar now = Calendar.getInstance();
    now.add(Calendar.DAY_OF_MONTH, days);
    String endDate = sdf.format(now.getTime());
    return endDate;
     ...
     * @return
     */
    public static Date stringFormat2Date(SimpleDateFormat sdf,String time){
    	Date date=null;
    	try {
			date=sdf.parse(time);
...
//    System.out.println(""+days+"天"+hours+"小时"+minutes+"分");  
    ...
    /**
     * 获取yyyyMMdd HHmmss格式的时间
     */
    public static String getTimeFormat2() {    
        return dataTimeFormat2.format(new Date());  
    } 
     ...
     */  
    public static SimpleDateFormat newShortYMDFormat() {  
     ...
     * @return 
     */  
    public static String getDate1(String timestampString,String dateFormat)  
    {  
     ...
     * @return
     */
    public static String getCurrentDateTimeAddSecond(int second) {  
    	Date date = new Date();
        long s = date.getTime();  
        s = s + second * 1000;  
        date =  new Date(s);  
    ...
    public static String getCurrentMMddHHmmss() {  
        Date date = new Date();  
        return dataTimeFormat1.format(date);  
    }  
    ...
    */  
    ...
    public static int compareEndAndStart(String start, String end) throws Exception {  
        ...
        } else if(12 == start.length()){
        	s = dataTimeFormat3.parse(start).getTime();
        } else {  
        ...
        }else if(12 == end.length()){
        	e = dataTimeFormat3.parse(end).getTime();
        } else {  
...
//          SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");  
        ...
        public static void main(String[] args) {  
        	System.out.println(getCurrentDateTimeAddSecond(100));
//          getSubTwoTime("2016-04-13","2016-04-15");  
//          SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd");  
//            System.out.println(getSubTwoTimeYY("2016-04-14","2016-04-21"));  
//        	System.out.println(DateUtils.getCurrentDate().replaceAll("-", ""));
//        	System.out.println(getShortYMDHMS());
//        	System.out.println(getBeforeThreeMonth());
//        	System.out.println(getDate1("1498870526000","yyyy-MM-dd HH:mm:ss"));
//        	System.out.println(getDate1("1527782400000","yyyy-MM-dd"));
